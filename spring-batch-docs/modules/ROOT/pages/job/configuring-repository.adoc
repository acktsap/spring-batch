...
WARNING: The `derby` database type is deprecated as of Spring Batch 6.1.0 and will be
removed in version 7.0.0. If you are currently running the job repository on Apache
Derby, you should plan a migration to another supported database platform.
